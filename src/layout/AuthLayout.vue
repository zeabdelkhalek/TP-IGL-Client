                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <router-link class="nav-link nav-link-icon" to="/">
                            ...
                            <span class="nav-link-inner--text">Etudiants</span>
                        </router-link>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <router-link class="nav-link nav-link-icon" to="/profile">
                            ...
                            <span class="nav-link-inner--text">Ajouter étudiant</span>
                        </router-link>
                    </li>
                </ul>
            </template>
                ...
                <div class="header-body text-center mb-7">
                    <div class="row justify-content-center">
                        <div class="col-lg-5 col-md-6">
                            ...
                            <p class="text-lead text-white">Utilisez notre application pour une meilleure gestion administrative.</p>
                        </div>
                    </div>
                </div>
            </div>
